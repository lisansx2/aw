...
@Controller
@RequestMapping("/reports/shopHistoryBalanceReport")
public class ShopHistoryBalanceReportController extends JasperReportsBaseController{
	
	private String indexViewName = "redirect:/reports/shopHistoryBalanceReportIndex";
	...
	public String showReportIndex(){
		return "reports/shopHistoryBalanceReportIndex";
	}
