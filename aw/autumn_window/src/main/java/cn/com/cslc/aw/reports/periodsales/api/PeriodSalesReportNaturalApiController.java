...
@RestController
@RequestMapping("/api/reports/periodSalesReportNatural")
public class PeriodSalesReportNaturalApiController extends BaseApiController{
...
//		queryCondition.setGameNoSet(gameNoSet);
		...
		Page<QueryPeriodSalesResult> page = periodSalesReportService.queryPeriodSalesByConditionNatural(queryCondition, dataTablesRequest.getPageRequest());
