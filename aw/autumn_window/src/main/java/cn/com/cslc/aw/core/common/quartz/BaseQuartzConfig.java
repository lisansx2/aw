...
public  class BaseQuartzConfig {
	...
	protected  JobDetailFactoryBean createJobDetail(Class jobClass) {
	...
	protected  SimpleTriggerFactoryBean createSimpleTrigger(JobDetail jobDetail, long pollFrequencyMs) {
