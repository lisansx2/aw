...
@Controller
@RequestMapping("/reports/periodSalesReportNatural")
public class PeriodSalesReportNaturalController extends JasperReportsBaseController{
	
	private String indexViewName = "redirect:/reports/periodSalesReportNatural";
	...
	public String showReportIndex(){
		return "reports/periodSalesReportNaturalIndex";
	}
